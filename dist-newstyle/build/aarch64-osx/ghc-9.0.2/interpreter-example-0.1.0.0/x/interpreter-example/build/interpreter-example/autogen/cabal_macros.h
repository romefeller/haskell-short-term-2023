...
/* package interpreter-example-0.1.0.0 */
#ifndef VERSION_interpreter_example
#define VERSION_interpreter_example "0.1.0.0"
#endif /* VERSION_interpreter_example */
#ifndef MIN_VERSION_interpreter_example
#define MIN_VERSION_interpreter_example(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_interpreter_example */
...
#define CURRENT_COMPONENT_ID "interpreter-example-0.1.0.0-inplace-interpreter-example"
